# https://colab.research.google.com/drive/1RJNBExwa4sy4YdbH3zEntsce8v1vH-64?authuser=1#scrollTo=xUoTIZQsq7Ls
# This activity check/done in colab, so code is in Ac1.py file. Below code is for reference only. Use the file dtabase.sqlite for this activity.
